...
#include <SoftEasyTransfer.h>                                         //For serial transfering to ESP
#include <SoftwareSerial.h>                                           //For software serial
SoftwareSerial mySerial(10, 11);                                      //Assing MCU pins to software serial
SoftEasyTransfer ET;
...
char prefixChar = 's';   // Starting Character before sending any data across the Serial
...
{ 
  ...
  Serial.print("Vrms detectado"); Serial.println(vrms); // adiconado para verificar calculo
